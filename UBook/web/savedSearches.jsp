...
<html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<SavedSearch> saved = database.Database.getSavedSearches(username);
            Iterator<SavedSearch> it = saved.iterator();
        %>
                ...
                <div class="panel-body">
                    <div class="panel  panel-body-custom">
                        <div class="panel-body">
                            ...
                            <%
                                while (it.hasNext()) {
                                    SavedSearch search = it.next();
                                    Book book = DatabaseActions.getBooksInfo(search.getBookID());                                
                                    String negotiable = "";
